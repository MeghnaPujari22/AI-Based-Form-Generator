                    ...
                    <div class="card-body">
                        <form id="generatorForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="prompt" class="form-control" rows="5" placeholder="Example: Create a portfolio website with a hero section, projects grid, and contact form..." required></textarea>
                            </div>
        ...
        function renderHistory() {
            ...
            document.querySelectorAll('.history-item').forEach(item => {
                item.addEventListener('click', () => {
                    ...
                    const history = JSON.parse(localStorage.getItem('websiteHistory') || '[]');
                    const selected = history.find(h => h.timestamp === item.dataset.timestamp);
                    if (selected) {
                        document.getElementById('prompt').value = selected.prompt;
